 ...
 ----------------------------------------*/
   ...
   $(document).ready(function() {
       ...
       $(".dropdown-filter, .mobile-list-filter, .btn-close").on('click', function () {
       ...
       //Partner slider
       var partner_slider = new Swiper('.top-builder-wrap', {
           slidesPerView: 5,
           spaceBetween: 30,
           loop: false,
           speed: 1000,
       ...
       var team_slider = new Swiper('.team-wrapper', {
           ...
           breakpoints: {
              ...
              //Listing Slider
              var team_slider = new Swiper('.listing-wrapper', {
                slidesPerView: 5,
                loop: false,
                observer: true,
                observeParents: true,
